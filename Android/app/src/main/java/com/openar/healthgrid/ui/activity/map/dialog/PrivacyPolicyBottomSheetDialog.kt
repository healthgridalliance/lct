...
class PrivacyPolicyBottomSheetDialog private constructor(): BaseBottomSheetDialog() {
    ...
    companion object {
        ...
        fun newInstance(): PrivacyPolicyBottomSheetDialog = PrivacyPolicyBottomSheetDialog()
    }
}
...
class MapsViewModel : ViewModel(), ApiContractBase.ViewModel {
    ...
    fun initApplication() {
        PreferenceStorage.addPropertyBoolean(HealthGridApplication.getApplicationContext(), PreferenceStorage.NEED_LOAD_SETTINGS, false)
    ...
    override fun onGetSettingsError(error: String) {
        PreferenceStorage.addPropertyBoolean(
            HealthGridApplication.getApplicationContext(),
            PreferenceStorage.NEED_LOAD_SETTINGS,
            true
        )
    }
    ...
    override fun onGetAppParameters(parameters: AppParametersObject) {
        PreferenceStorage.addPropertyString(
            ...
            parameters.data?.maxColor ?: Constants.MAX_COLOR_DEFAULT
        )
        PreferenceStorage.addPropertyString(
            HealthGridApplication.getApplicationContext(),
            PreferenceStorage.LEGEND_MIN_COLOR,
            parameters.data?.minColor ?: Constants.MIN_COLOR_DEFAULT
        )
        PreferenceStorage.addPropertyInt(
            HealthGridApplication.getApplicationContext(),

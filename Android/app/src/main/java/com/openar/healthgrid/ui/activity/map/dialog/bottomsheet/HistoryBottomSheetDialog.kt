...
import com.openar.healthgrid.ui.activity.map.dialog.TooltipInfoDialog
...
class HistoryBottomSheetDialog : NetworkBottomSheet(), OnMapReadyCallback,
    ...
    override fun onCreateView(
        ...
        heatZonesViewModel.updateHeatZones()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        legend_exit.setOnClickListener {
            ...
            mapsViewModel.loadTrackingStatusValue(requireContext())
    ...
    private fun prepareToolTipDialogForShowing() {
        ...
        fragmentManager?.beginTransaction()
            ?.add(
                TooltipInfoDialog.newInstance(),
                TooltipInfoDialog.MAP_LEGEND_DIALOG_TAG
            )
    ...
    companion object {
        ...
        fun newInstance(): HistoryBottomSheetDialog =

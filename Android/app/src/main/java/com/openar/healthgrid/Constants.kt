...
object Constants {
    const val MAX_DISTANCE_EXPOSURE_METER = 10
    const val MIN_DISPLACEMENT_METER = 15f
    const val KEEP_MAX_HOURS = 24
    const val CHECK_EXPIRED_DATA_INTERVAL_HOURS = 24L
    const val TURN_OFF_TRACKING_MINUTES = 8*60L
